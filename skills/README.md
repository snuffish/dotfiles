...
| Group                            | Count | Skills                                                                                                                |
| -------------------------------- | :---: | -------------------------------------------------------------------------------------------------------------------- |
| General (top level)              |  22   | `artifacts`, `clean`, `code-documentation`, `code-review`, `code-review2`, `core`, `create-skill`, `explain`, `expressive`, `investigate`, `manual-testing`, `modern-csharp`, `organize`, `plan`, `pr-feedback-review`, `pr-summary`, `problem`, `refine`, `reload-skills`, `review`, `squash-ef-core-migrations`, `what-am-I-missing` |
